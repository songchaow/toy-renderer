...
int main(int argc, char *argv[])
{
      ...
      PointLight spot(RGBSpectrum(35.f, 35.f, 35.f), Point3f(), std::cos(Pi / 8.f), Vector3f(0.f, 0.f, 1.f));
      ...
      Primitive* ground = CreatePrimitiveFromModelFile("resources/untitled.obj");
