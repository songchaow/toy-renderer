...
bool Sphere::Intercept(const Ray& r0, Interaction& i) {
      Ray rt(world2obj(r0));
      Float a = rt.d.x*rt.d.x + rt.d.y*rt.d.y + rt.d.z*rt.d.z;
      Float b = 2 * (rt.d.x*rt.o.x + rt.d.y*rt.o.y + rt.d.z*rt.o.z);
      Float c = rt.o.x*rt.o.x + rt.o.y*rt.o.y + rt.o.z*rt.o.z - r * r;
      Float t0, t1, ti;
      ...
      Float theta = std::acos(Clamp(pHitLocal.z / r, -1, 1));
      Float phi;
      ...
      i.dpdv = obj2world(Vector3f(Pi*pHitLocal.z*std::cos(phi), Pi*pHitLocal.z*std::sin(phi), -Pi * r*std::sin(theta)));
      return true;
}