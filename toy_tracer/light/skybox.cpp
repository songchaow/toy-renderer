...
TriangleMesh Skybox::cube = CreateTriangleMesh(_worldPositions, std::vector<LayoutItem>(1, DEFAULT_POINT3F_LAYOUT),
      8, (char*)indices, 12, GL_UNSIGNED_INT, Transform::Identity(), GL_TRIANGLES);
